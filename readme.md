...
user enter some topics ( up to 5) and this application establish the connection with twitter and filter the stream content
...
build and generate jar file
 ...
 Need jre 1.8 environment to run the jar file --
 ...
 System response with starting writing these topics to files: movie.txt, sports.txt, Canada.txt, skate.txt file

 enter "quit" to quit the program

 There is twitterConfig.propertis file. There are the twitter tokens setting and writing file(s) relative path setting
